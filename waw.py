...
def uaku():
	try:
		...
		a=requests.get('https://raw.githubusercontent.com/FarzCracking/nbds/main/agent.txt').text
		ua=open('.agent.txt','w')
...
def menu(my_name,my_id):
	...
	cetak(nel('\tHai Pengguna Bernama [green]%s[white] Tolol'%(my_name)))
...
def setting():
	...
	print(f'{N}├───[{H}4{N}] Free {k}[ERROR]{N}')
...
'Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-G950U Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/9.0 Chrome/67.0.3396.87 Mobile Safari/537.36',
